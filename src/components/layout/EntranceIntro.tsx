  ...
  return (
    ...
    >
      ...
      <div className="absolute top-6 right-6 z-20 flex items-center space-x-3">
        ...
        <button
          onClick={toggleSound}
          className="h-10 px-3.5 rounded-full bg-black/60 hover:bg-black/80 border border-white/20 backdrop-blur-md text-amber-200 hover:text-white flex items-center space-x-1.5 text-xs font-serif transition-all"
        >
        ...
        <button
          ...
          className="h-10 px-5 rounded-full bg-black/60 hover:bg-black/80 border border-[#d4af37]/60 hover:border-[#d4af37] backdrop-blur-md text-amber-200 hover:text-white flex items-center space-x-2 text-xs font-serif font-bold uppercase tracking-wider transition-all shadow-lg active:scale-95"
        >
      ...
      <div className="absolute bottom-8 sm:bottom-12 inset-x-0 z-20 flex justify-center pointer-events-auto">
        <button
          onClick={handleFinish}
          className="group px-7 py-3 rounded-full bg-gradient-to-r from-[#d4af37] via-[#f3e5ab] to-[#d4af37] text-zinc-950 font-serif text-xs sm:text-sm font-bold uppercase tracking-[0.2em] shadow-[0_0_35px_rgba(212,175,55,0.6)] hover:shadow-[0_0_50px_rgba(212,175,55,0.9)] hover:scale-105 active:scale-95 transition-all flex items-center space-x-2.5"
        >
